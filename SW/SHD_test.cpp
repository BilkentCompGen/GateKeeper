...
void printHelp(){
    cout << "A sample application that tests SHD implementation on FPGA" << endl;
	cout << "Usage: 1) ./SHD_test [INPUT_SIZE_IN_BYTES] [OUTPUT_FILE_NAME]" << endl; 
	cout << "	2) ./SHD_test [INPUT_FILE_NAME] [OUTPUT_FILE_NAME]" << endl; 
...
int main(int argc, char* argv[]){
    ...
    printf("Starting SHD Test with %d bytes! \n", dna_size);
